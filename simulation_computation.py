...
kI1=2.51945; kI2=2.51945; kI3=2.51945;      # Constante liant couple et courant des moteurs
kE1=3.3942;  kE2=3.3942;  kE3=3.3942;       # Constante liant vitesse et fem des moteurs
la1=0.0670;  la2=0.0670;  la3=0.0670;       # Coefficient de frottement des moteurs
Kpos=4200;   Kvit=130;                      # Gains des correcteurs
...
S=np.diag([R1/kI1,R2/kI2,R3/kI3]); Sinv=np.linalg.inv(S)
...
#résolution
Ysol=spint.odeint(EqDiff,Y0,time,args=(STADE,R,mA,Sinv,L,G,g,Kpos,Kvit,time,vitXref,posXref,vitThref,posThref,Force_pert))


#Extraction des valeurs à partir des solutions
x=Ysol[:,0];     y=Ysol[:,1];      z=Ysol[:,2];
xpt=Ysol[:,3];   ypt=Ysol[:,4];    zpt=Ysol[:,5];
TH1=Ysol[:,6];   TH2=Ysol[:,7];    TH3=Ysol[:,8];
TH1pt=Ysol[:,9]; TH2pt=Ysol[:,10]; TH3pt=Ysol[:,11];
